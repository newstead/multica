...
- DeepSeek via Codex (`codex` on PATH, `DEEPSEEK_API_KEY` configured for DeepSeek agents, and `MULTICA_DEEPSEEK_BASE_URL` pointing at a Responses-compatible DeepSeek adapter/router)
