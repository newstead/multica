  ...
  case "$line" in
    ...
    *'"method":"session/prompt"'*)
      ...
      if [ -n "$GROK_USAGE" ]; then
        ...
        printf '{"jsonrpc":"2.0","id":%s,"result":{"stopReason":"end_turn","_meta":{"sessionId":"ses_new","modelId":"grok-4.5","inputTokens":120,"outputTokens":30,"cachedReadTokens":20,"usage":{"inputTokens":120,"outputTokens":30,"totalTokens":150,"cachedReadTokens":20,"reasoningTokens":7,"modelCalls":1,"costUsdTicks":98765}}}}\n' "$id"
      else
...
func TestGrokPropagatesMCPAndUsage(t *testing.T) {
	...
	if usage.InputTokens != 100 || usage.OutputTokens != 30 || usage.CacheReadTokens != 20 || usage.ReasoningTokens != 7 {
