...
func (c *Client) CompleteTask(ctx context.Context, taskID, output, branchName, sessionID, workDir string, diffStats *DiffStats, sessionRolloutMissing bool, retiredSessionID string, memoryRecall []protocol.MemoryRecallProvenance) error {
