...
func (c *Client) CompleteTask(ctx context.Context, taskID, output, branchName, sessionID, workDir string, diffStats *DiffStats, sessionRolloutMissing bool, memoryRecall []protocol.MemoryRecallProvenance, retiredSessionID string) error {
