...
func (d *Daemon) reportTerminalTask(parentCtx context.Context, report terminalTaskReport) error {
	...
	case terminalTaskReportComplete:
		...
		return d.client.CompleteTask(ctx, report.taskID, report.output, report.branchName, report.sessionID, report.workDir, diffStats, report.sessionRolloutMissing, report.retiredSessionID, report.memoryRecall)
