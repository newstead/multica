...
// For DeepSeek: writes {workDir}/AGENTS.md  (Codex-compatible; skills discovered natively via CODEX_HOME)
...
func runtimeConfigPath(workDir, provider string) string {
	...
	case "codex", "deepseek", "copilot", "opencode", "deveco", "openclaw", "hermes", "pi", "cursor", "kimi", "kiro", "antigravity", "qoder", "qoderclicn", "traecli", "grok":
