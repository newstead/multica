...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"memory_dual_write_telemetry":     workspaceDelete,
	"memory_event":                    workspaceDelete,
	"memory_provider_delivery":        workspaceDelete,
	"memory_recall_sample":            workspaceDelete,
	"memory_workspace_config":         workspaceDelete,
