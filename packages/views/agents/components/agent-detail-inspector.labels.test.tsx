...
describe("AgentDetailInspector labels", () => {
  ...
  // Fork divergence from upstream (MUL-5600 removed agent labels upstream):
  // our fork keeps the workspace-label picker on the agent profile, so the
  // picker row must render.
  it("offers the label picker", () => {
    renderWithI18n(
    ...
    expect(screen.getByTestId("resource-label-picker")).toBeInTheDocument();
